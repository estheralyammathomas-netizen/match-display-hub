...
export type Database = {
  ...
  public: {
    Tables: {
      matches: {
        Row: {
          ...
          current_batting_team: number | null
          current_period: number | null
          current_set: number | null
          id: string
          show_break_screen: boolean | null
    ...
    Functions: {
      ...
      is_match_creator: { Args: { _match_id: string }; Returns: boolean }
    }
    Enums: {
      app_role: "admin" | "user"
      match_status: "upcoming" | "live" | "halftime" | "break" | "finished"
      sport_type:
        | "volleyball"
        | "basketball"
        | "football"
